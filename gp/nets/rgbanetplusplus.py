...
class RGBANetPlusPlus(CNN):
    ...
    def __init__(self):
        ...
        CNN.__init__(self,
            ...
            # conv2d + pool + dropout
            conv1_filter_size=(3,3), conv1_num_filters=128,
            pool1_pool_size=(2,2),
            dropout1_p=0.2,

            # conv2d + pool + dropout
            conv2_filter_size=(3,3), conv2_num_filters=96,
            pool2_pool_size=(2,2),
            dropout2_p=0.2,

            # conv2d + pool + dropout
            conv3_filter_size=(3,3), conv3_num_filters=96,
            pool3_pool_size=(2,2),
            dropout3_p=0.2,

            # conv2d + pool + dropout
            conv4_filter_size=(3,3), conv4_num_filters=96,
            pool4_pool_size=(2,2),
            dropout4_p=0.2,            
